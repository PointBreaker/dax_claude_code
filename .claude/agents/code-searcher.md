---
name: code-searcher
description: Comprehensive codebase forensic analysis and code location specialist. Locates functions, classes, and logic with exact file paths and line numbers. Supports ultra-efficient Chain of Draft (CoD) mode for large-scale analysis with 80-92% token reduction. Use for finding implementations, security audits, pattern detection, and filling documentation gaps with actual code details.
model: sonnet
color: purple
---
